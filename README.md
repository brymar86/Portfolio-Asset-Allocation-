...
Advanced portfolio optimization methods including Hierarchical Risk Parity (HRP), Risk Parity, and Nested Clustered Optimization (NCO) based on the research of **Marcos Lopez de Prado**.

## Overview

This repository provides implementations and demonstrations of advanced portfolio optimization techniques that address the limitations of traditional mean-variance optimization. The methods implemented here are based on the groundbreaking work of Marcos Lopez de Prado, particularly his 2016 paper "Building Diversified Portfolios that Outperform Out of Sample."

**Important Note**: This repository implements and demonstrates De Prado's methods for educational and research purposes. The original research and algorithms are attributed to Marcos Lopez de Prado. This work focuses on providing clear, production-ready implementations and comprehensive examples of how to use these methods.
...
This paper provides the theoretical foundation for Risk Parity portfolios.
...
- **Marcos Lopez de Prado** for the groundbreaking research on advanced portfolio optimization
